(function () {
  ...
  const FALLBACK_NONE_FAVICON = 'https://cdn.jsdelivr.net/gh/nexora240-lgtm/Nexora-Assets@main/logos/nexora-amber.png';
  ...
  function assetFor(name) {
    ...
    return s ? `https://cdn.jsdelivr.net/gh/nexora240-lgtm/Nexora-Assets@main/favicon/${s}.png` : '';
  }
...
(function () {
  const LOGO_MAP = {
    'midnight-amber': 'https://cdn.jsdelivr.net/gh/nexora240-lgtm/Nexora-Assets@main/logos/nexora-amber.png',
    'midnight-blueberry': 'https://cdn.jsdelivr.net/gh/nexora240-lgtm/Nexora-Assets@main/logos/nexora-blueberry.png',
    'midnight-grape': 'https://cdn.jsdelivr.net/gh/nexora240-lgtm/Nexora-Assets@main/logos/nexora-grape.png'
  };

  const FAVICON_MAP = {
    'midnight-amber': 'https://cdn.jsdelivr.net/gh/nexora240-lgtm/Nexora-Assets@main/favicon/favicon-amber.png',
    'midnight-blueberry': 'https://cdn.jsdelivr.net/gh/nexora240-lgtm/Nexora-Assets@main/favicon/favicon-blueberry.png',
    'midnight-grape': 'https://cdn.jsdelivr.net/gh/nexora240-lgtm/Nexora-Assets@main/favicon/favicon-grape.png'
  };

  const DEFAULT_LOGO = 'https://cdn.jsdelivr.net/gh/nexora240-lgtm/Nexora-Assets@main/logos/nexora-amber.png';
  const DEFAULT_FAVICON = 'https://cdn.jsdelivr.net/gh/nexora240-lgtm/Nexora-Assets@main/favicon/favicon-amber.png';
